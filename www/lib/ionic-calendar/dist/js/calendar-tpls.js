...
angular.module("templates/rcalendar/monthviewEventDetail.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("templates/rcalendar/monthviewEventDetail.html",
    ...
    "            <td class=\"event-detail\" style=\"white-space: normal;\">{{::event.title}}</td>\n" +
    "            <td class=\"event-detail\"><i class=ion-edit style=\"float: left;font-size: 20px;\" ng-click=\"eventEdit({event: event.Id})\"></i> <i class=ion-trash-b style=\"float: right;font-size: 20px;\" ng-click=\"eventDelete({event:event.Id})\"></i></td>\n" +
    "        </tr>\n" +
